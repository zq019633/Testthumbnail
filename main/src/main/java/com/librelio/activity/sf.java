...
public class sf extends FragmentActivity {
    ...
    private int zqposition;
    private int zqposition1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        zqposition1 = getIntent().getIntExtra("position",1);
         Log.e("position222",""+ zqposition1);
...
//					mPreview.scrollToPosition(((i == 0) ? 0 : i * 2 - 1));
        ...
        if(orientation == mOrientation)
            ...
            docView.setDisplayedViewIndex(zqposition1);
    ...
    void makeButtonsView() {
        ...
        mOutlineButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Log.e("zq","我被点击了");
                Intent intent = new Intent(sf.this, listActivity.class);
                Bundle mBundle = new Bundle();
                mBundle.putSerializable("core", core);
